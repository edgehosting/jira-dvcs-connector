...
public class GitlabAPI {
     ...
     */
    public GitlabGroupMember addGroupMember(GitlabGroup group, GitlabUser user, Integer accessLevel) throws IOException {
     ...
     * @throws IOException on gitlab api call error
     */
    public GitlabGroupMember addGroupMember(Integer groupId, Integer userId, Integer accessLevel) throws IOException {
        Query query = new Query()
                .appendIf("id", groupId)
     ...
     * @throws IOException on gitlab api call error
     */
    public GitlabProjectMember addProjectMember(GitlabProject project, GitlabUser user, Integer accessLevel) throws IOException {
     ...
     * @throws IOException on gitlab api call error
     */
    public GitlabProjectMember addProjectMember(Integer projectId, Integer userId, Integer accessLevel) throws IOException {
        Query query = new Query()
