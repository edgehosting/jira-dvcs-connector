...
public class To_11_NewRepositoryColumn implements ActiveObjectsUpgradeTask
{
    private static final Logger log = LoggerFactory.getLogger(To_11_NewRepositoryColumn.class);
