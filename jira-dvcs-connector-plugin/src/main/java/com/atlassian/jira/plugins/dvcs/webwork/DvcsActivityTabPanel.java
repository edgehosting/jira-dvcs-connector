...
public class DvcsActivityTabPanel extends AbstractIssueTabPanel
{
    ...
    public DvcsActivityTabPanel(PermissionManager permissionManager, ChangesetService changesetService,
                        ApplicationProperties applicationProperties, IssueLinker issueLinker, TemplateRenderer templateRenderer, RepositoryService repositoryService, RepositoryActivityDao activityDao)
    {
