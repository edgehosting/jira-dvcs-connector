...
function updateSyncStatus(repo) {
    ...
    if (repo.sync) {
        ...
        if (repo.sync.smartCommitErrors.length > 0) {
            errorSmrtcmmtIcon.addClass("error_smrtcmmt aui-icon aui-icon-small aui-iconfont-error aui-color-red");
            ...
            errorSmrtcmmtIcon.removeClass("error_smrtcmmt aui-icon aui-icon-small aui-iconfont-error aui-color-red")
        }
    ...
    AJS.$.ajax( 
    	{
            ...
            function (registration) {
                if (registration.callBackUrlInstalled != checkedValue) {
                    ...
                    errorStatusIcon.addClass("admin_permission aui-icon aui-icon-small aui-iconfont-warning aui-color-yellow");
            ...
            var errorStatusIcon = AJS.$("#error_status_icon_" + repoId);
            errorStatusIcon.removeClass("admin_permission aui-iconfont-warning aui-color-yellow").addClass("aui-icon aui-icon-small aui-iconfont-error aui-color-red");
