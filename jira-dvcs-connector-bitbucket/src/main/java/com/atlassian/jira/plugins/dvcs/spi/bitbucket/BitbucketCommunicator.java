...
public class BitbucketCommunicator implements DvcsCommunicator
{
    ...
    {
        return MessageFormat.format("{0}/{1}/{2}/changeset/{3}", repository.getOrgHostUrl(),
    ...
    public DvcsUser getUser(Repository repository, Changeset changeset)
    {
        ...
        try
        {
            ...
            String responseString = requestHelper.get(Authentication.ANONYMOUS, "/users/" + CustomStringUtils.encode(username), null, apiUrl);
