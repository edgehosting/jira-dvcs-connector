...
public class TestDefaultBitbucket
{
    ...
    public void testGetChangesetsLargeFromTip() throws Exception
    {
        ...
        when(bitbucketConnection.getChangesets(BitbucketAuthentication.ANONYMOUS, "atlassian", "jira-bitbucket-connector", "tip", DefaultBitbucket.PAGE_SIZE)).thenReturn(resource("TestBitbucket-changesets-tip.json"));
        ...
        verify(bitbucketConnection, times(1)).getChangesets(BitbucketAuthentication.ANONYMOUS, "atlassian", "jira-bitbucket-connector","tip", DefaultBitbucket.PAGE_SIZE);
