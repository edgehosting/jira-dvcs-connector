    ...
    function getRelativePastDate(date, diff, day_diff, isFineGrained) {
        ...
        if (day_diff == 0) {
            ...
            return day_diff <= 1 && (isFineGrained && AJS.format(geti18n('past.dayWithTime'), date.toString('t')) || geti18n('past.day')) || // Yesterday (at HH:MM)
                   ...
                   day_diff < 365 && (isFineGrained && AJS.format(geti18n('datetime'), date.toString('MMM') + " " + date.toString('dS'), date.toString('H') + ":" + date.toString('m') + date.toString('tt')) || date.toString('MMM') + " " + date.toString('dS')) || // Month DD (at HH:MM)
